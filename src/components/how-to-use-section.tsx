import { ArrowRight, BarChart3, Send, Target, Upload } from 'lucide-react'
  ...
  const steps = [
    {
      ...
      details:
        'Support for all major audio formats, high-res images, and video content'
    },
    {
      icon: Target,
      ...
      details:
        "AI-powered audience insights based on Universal Music Group's extensive data"
    },
    {
      icon: Send,
    ...
    },
    {
      ...
      description:
        'Monitor real-time analytics, engagement metrics, and ROI across all your marketing initiatives.',
      details:
      ...
      <div className="container mx-auto px-4">
        <div className="text-center mb-16">
          ...
          <p className="text-xl text-muted-foreground max-w-3xl mx-auto">
            Launch successful marketing campaigns for Universal Music Group
            artists in four simple steps
          </p>
        </div>
